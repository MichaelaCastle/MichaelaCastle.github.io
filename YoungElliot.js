window.onload = () => {
    ...
    <p class="answer">College student (Business major)</p>
    <div class='brLarge'></div>
    ...
    <p class="answer">Mutations and powers do not exist at this point in the story</p>`;
    document.querySelector('#Appearance').innerHTML = `
    <p class="question">Height</p>
    <p class="answer">6'3.5"</p>
    <p class="answer">191.77 cm</p>
    <p class="question">Weight</p>
    <p class="answer">127 lbs.</p>
    <p class="answer">57.61 kg</p>
    <div class='brLarge'></div>
    <p class="question">Hair color</p>
    <p class="answer">Brown</p>
    <p class="question">Hair style</p>
    <p class="answer">Straight, parted in the middle, long. He normally likes to keep his hair in a ponytail</p>
    <div class='brLarge'></div>
